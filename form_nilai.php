                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="nilai_uts" value="" size="6" class="form-control"/>
                            </div>
                            <div class="form-group">
                                <label>Nilai UAS</label>
                                <input type="number" name="nilai_uas" value="" size="6" class="form-control"/>
                            </div>
                            <div class="form-group">
                                <label>Nilai Tugas Praktikum</label>
                                <input type="number" name="nilai_tugas" value="" size="6" class="form-control"/>
                            </div>
                        </div>
                    </div>
